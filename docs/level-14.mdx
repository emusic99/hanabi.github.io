...
import TrashBluff2 from "./level-14/trash-bluff2.yml";
import TrashFinesse from "./level-14/trash-finesse.yml";
import TrashFinesse2 from "./level-14/trash-finesse2.yml";
...
- For example, if a trash 2 is clued with number 2, then another player must have a playable 2 on their _Finesse Position_.
- After a _Trash Finesse_, the player who was clued should _Chop Move_ all of the cards to the right of the trash card (similar to how a _Trash Chop Move_ works).
...
- Just like a _Trash Finesse_, a _Trash Bluff_ will also _Chop Move_ all of the cards to the right of the trash card (similar to how a _Trash Chop Move_ works).
...
### Trash Bluffs vs Trash Finesses
...
- What if the recipient of the clue does **not** know that the card that the clued card is trash? Then, they would go on to misplay that card, mistaking it for a "normal" _Play Clue_.
- If players misrepresent the identity of a trash card in this way, it is a signal that a player has the originally-promised card on their _Finesse Position_.
- After a _Trash Finesse_, the player who was clued should _Chop Move_ all of the cards to the right of the focused card. (In other words, you can think of a _Trash Finesse_ as both a _Finesse_ and a _Trash Chop Move_ at the same time.)
  - If the clued card in a _Trash Finesse_ was already on chop, then nothing extra happens.
  - For level 24 players, an [extra thing happens](level-24.mdx#trash-finesses-and-trash-bluffs-are-always-unnecessary).
- For example, in a 4-player game:
  - All the 1's are played on the stacks except for red 1 and yellow 1.
...
- In a regular _Bluff_, Alice fibs Bob by pretending he has the connecting card on his _Finesse Position_. According to _Bob's Truth Principle_, Bob must assume Alice is telling the truth and only knows it's a fib after he blind-plays.
- Similarly, in a _Trash Bluff_, Alice clues a trash card, forcing Bob to blind-play his finesse. Bob will assume it's the originally-promised card and only knows it's a fib after he blind-plays.
- Just like a _Trash Finesse_, a _Trash Bluff_ will also _Chop Move_ all of the cards to the right of the focused card.
- For example, in a 3-player game:
  - All of the 1's are played on the stacks **except** for the red 1.
  - Cathy has no clued cards in her hand.
  - Alice clues Cathy number 1, which only touches her slot 2 card. This card is a blue 1, but Cathy will assume that it is a red 1.
