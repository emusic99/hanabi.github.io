...
import ChopMoveIgnitionOneCard from "./level-21/chop-move-ignition-one-card.yml";
import ChopMoveIgnitionInteraction from "./level-21/chop-move-ignition-interaction.yml";
import ChopMoveIgnitionTwoCards from "./level-21/chop-move-ignition-two-cards.yml";
...
- Similar to an _Ambiguous Finesse_, an _Ambiguous Double Ignition_ is possible. Specifically, this means that three or more players have a playable card on _Finesse Position_. In this situation, we strongly define who is supposed to be blind-playing:
  - The first _Ignition_ **must always be on the first player that does not already have a known-playable card**.
...
- If a player clues one or more new trash cards, and the cards are known to be trash, then there are usually 2 possible interpretations:

#### 1) A _Trash Chop Move_
...
- However, players can know that _Trash Chop Move_ is impossible if:
  ...
  - They are the clue-receiver and they can determine that there are no cards left to _Chop Move_. (Meaning that all of the cards are accounted for, or all of the remaining cards could be given a direct _Play Clue_ or a direct _Save Clue_.)

#### 2) A _Trash Push_ (or a _Trash Push Finesse_)
...
- However, players can know that a _Trash Push_ is impossible if:
  ...
  - They are the clue-receiver and they can determine that there are no more cards left to _Trash Push_.
...
- For example, in a 4-player game:
  ...
  - At first, Cathy thought that Alice's clue was a _Early 5's Chop Move_. However, if that was the case, then Bob would not have blind-played anything. Since he blind-played his _Finesse Position_ card, this must be a _Chop Move Ignition_. Cathy blind-plays her slot 4 card (the card to the right of the clued 5).

<ChopMoveIgnitionOneCard />

- Sometimes, it can be useful to _Chop Move_ a playable card. Something is only a _Chop Move Ignition_ if there is no other good reason for the _Chop Move_. Specifically, the player might want to:
...
- In general, _Chop Move_-related clues are turned off as soon as there are no cards left to _Chop Move_. Specifically, this means _one-away-from-playable_ cards that cannot be given a direct _Play Clue_ or _Save Clue_. Thus, if there are no cards left to _Chop Move_, a _Chop Move Ignition_ would transform into something else, like a _Play Clue_ or a _Double Ignition_ of some sort.
...
- However, for level 21 players, _Play Clues_ like this are **turned off**. In other words, every number 5 clue that focuses a 5 that is exactly one-away-from-chop would always be a _5's Chop Move_. This is referred to as the _Chop Move Ignition Interaction_.
...
- First, see the previous section on [_Chop Move Ignition_ with one card _Chop Moved_](#the-chop-move-ignition-cmi-with-1-card-chop-moved).
- It is also possible to perform a _Chop Move Ignition_ that _Chop Moves_ two or more cards, but this is more complicated.
- This kind of _Chop Move Ignition_ is only valid if both of the following conditions are true:
  1. The leftmost _Chop Moved_ card is playable.
  2. The rightmost _Chop Moved_ card is trash or is a copy of an unclued card in the same hand.
- For example, in a 4-player game:
  ...
  - It is now Bob's turn. Bob sees that Cathy will interpret this as a _Trash Chop Move_ on slot 3 and slot 4.
  - Bob also knows that it is nonsensical to _Chop Move_ a playable red 2 - Alice could have just give a direct red _Play Clue_ to the red 2.
  - Thus, this must be a _Chop Move Ignition_. Bob blind-plays his _Finesse Position_ card. It is blue 2 and it successfully plays.
  - At first, Cathy thought that Alice's clue was a _Trash Chop Move_. However, if that was the case, then Bob would not have blind-played anything. Since he blind-played his _Finesse Position_ card, this must be a _Chop Move Ignition_. Cathy blind-plays her slot 3 card (the card to the right of the clued 1). It is a red 2 and successfully plays.
  - At the same time that Cathy marked her slot 3 card as playable, she also marked her slot 4 card as known trash.
  - Later on, Cathy discards her slot 4 card, and discovers that it is a blue 4. Since blue 4 was not trash at the time that the _Chop Move Ignition_ was given, Cathy marks _Elimination Notes_ in her hand for the other copy of the blue 4. (The rest of the team also marks _Elimination Notes_ in the same way.)

<ChopMoveIgnitionTwoCards />

- If three or more cards are _Chop Moved_, nothing is promised about the middle cards.
